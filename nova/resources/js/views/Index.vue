          ...
          'mb-6': resourceInformation.searchable && !viaHasOne,
            ...
            <div class="w-full flex items-center" :class="{ 'mb-6': !viaResource }">
                ...
                <create-resource-button
                    ...
                    :create-button-label="resourceInformation.createButtonLabel"
                    class="flex-no-shrink ml-auto"
                    :class="{ 'mb-6': viaResource }"
                >{{ attachButtonLabel || __('Attach :resource', { resource: singularName }) }}</create-resource-button>
            </div>
        </div>
            ...
            >
                <div class="flex items-center">
                    <div class="px-3" v-if="shouldShowCheckBoxes">
                        <!-- Select All -->
                        <dropdown dusk="select-all-dropdown" placement="bottom-end" class="-mx-2">
                ...
                <div class="flex items-center ml-auto px-3">
                    ...
                    <import-resource-button
                        v-if="!viaResource && resourceInformation.showImportButton"
                        :resource-name="resourceName"
                        :resource-label="headingTitle"
                    ></import-resource-button>
                    <!-- Action Selector -->
                    <action-selector
...
export default {
    ...
    computed: {
        ...
        attachButtonLabel() {
            if (this.field) {
                return this.field.attachButtonLabel
            }
        },
