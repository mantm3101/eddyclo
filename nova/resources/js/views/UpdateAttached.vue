<template>
  <loading-view :loading="loading">
    ...
    <heading class="mb-3">{{
      updateHeadingLabel || __('Update :resource', { resource: relatedResourceLabel })
    }}</heading>
    ...
    >
      ...
      <div class="flex items-center">
        ...
        >
          {{ confirmUpdateAnotherButtonLabel || __('Update & Continue Editing') }}
        </progress-button>
        ...
        >
          {{
            confirmUpdateButtonLabel || __('Update :resource', {
...
export default {
  ...
  computed: {
    ...
    updateHeadingLabel() {
      if (this.field) {
        return this.field.updateHeadingLabel
      }
    },
    ...
    confirmUpdateButtonLabel() {
      if (this.field) {
        return this.field.confirmUpdateButtonLabel
      }
    },

    // Phi
    confirmUpdateAnotherButtonLabel() {
      if (this.field) {
        return this.field.confirmUpdateAnotherButtonLabel
      }
    },
